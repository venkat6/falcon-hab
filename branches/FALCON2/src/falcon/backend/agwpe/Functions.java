	...
	public static String atochar(byte[]ba, int ofs, int len)
	{
		...
		for(int i=ofs;i<(ofs+len);i++)
		{
			...
			//see http://www.sv2agw.com/downloads/develop.zip, AGWPEAPI.HTM#_Toc500723812
                        ...
                        //newline is '\n' and ascii decimal value:10
                        //carriage return is '\r' and ascii decimal value:13
//                        if((b < 32 && b!=10 && b!=13) || b >126)ch = '.';
//                        else if(b==13) ch=(char)10; //replace carriage returns with newlines for parsing
                        if((b < 32 && b!=13) || b > 126) ch = '.'; //replace none printable characters with '.' but leave CR for delimiting AGWPE fields
			else ch = (char)b;
			s+=ch;
		}
		return s;
